...
export class Home extends Component {
    render() {
        return (
            <div>
                <main className="dark:bg-gray-900 bg-white h-screen">
                        ...
                        <div className="container mx-auto px-6 flex items-center justify-between">
                            ...
                            <div className="flex items-center">
                                <nav className="font-sen text-gray-800 dark:text-white uppercase text-lg lg:flex items-center hidden bg-gray-600 rounded-md">
                                    ...
                                    <a href="#destination" className="py-2 px-6 flex font-semibold">
                                        Destination
                                    </a>
                    ...
                    <div id="about" className="sm:flex items-center max-w-screen bg-gray-800">
                    ...
                    <div id="destination" className=" max-w-screen  px-2 bg-gray-800">
                    ...
                    <div id="contact" className="px-3 py-6 bg-black text-white ">
              ...
              Newsletters
                    ...
                    <footer className="flex flex-col space-y-10 justify-center  bg-gray-800 max-w-screen ">
                        ...
                        <nav className=" mt-10 flex justify-center flex-wrap gap-6 text-white font-medium text-xl">
                            ...
                            <a className="hover:text-yellow-400" href="#destination">Destination</a>
                        ...
                        <p className="text-center text-white font-semibold">&copy; 2024 Zen Traveller. All rights reservered.</p>
                    </footer>
