    ...
    render() {
        ...
        return (
            <>
                ...
                <div id="allCard" className="bg-white rounded-lg overflow-hidden shadow-lg ring-4 ring-yellow-500 ring-opacity-40
                    max-w-sm">
            ...
            if (this.props.data.availability === 'available') {
               ...
               /* const currentDate = moment().tz('Asia/Colombo');
                ...
                this.api.post(`/customer/byTheRoom`, {
                    ...
                    console.log("Buy Room", response);
                    toast.success("Booking Is Successful!");
                }).catch((error: any) => {
                    console.log("Not Buy Room", error);
                    toast("Not Buy Room" + error);
                }).finally(() => {
                     this.setState({ isButtonDisabled: true });
                });
            } else {
