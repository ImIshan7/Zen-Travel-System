                 ...
                 <div className="py-4 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
                    <div
                        ...
                        <div
                            ...
                            <div
                                className="flex flex-col justify-start items-start bg-white border-black border-2 rounded px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                                <p className="text-lg md:text-xl dark:text-blue-600 leading-6 xl:leading-5 text-blue-600 font-bold">Room Details</p>
                                <div
                                    ...
                                    <div
                                        ...
                                        <div className="w-full flex flex-col justify-start items-start space-y-8">
                                            <h3 className="text-xl dark:text-black xl:text-2xl font-semibold leading-6 text-gray-800">{data.title}</h3>
                                            <div className="flex justify-start items-start flex-col space-y-2">
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500 text-black font-bold">Type: </span>{data.room}
                                                </p>
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500  text-gray-950 font-bold">Room Count: </span>{data.roomCount}
                                                </p>
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500   text-gray-950 font-bold">Description: </span>{data.description}
                                                </p>
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500  text-gray-950 font-bold">Date: </span>{data.bookingDateTime}
                                                </p>
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500   text-gray-950 font-bold">Contact: </span>{data.customerContact}
                                                </p>
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500   text-gray-950 font-bold">Address: </span>{data.customerAddress}
                                                </p>
                                                <p className="text-sm dark:text-black font-bold leading-none text-gray-800"><span
                                                    className="dark:text-blue-500   text-gray-950 font-bold">Email: </span>{data.customerEmail}
                                                </p>
                                                <div className={`left-2 px-1 py-1 m-2 rounded-md text-sm font-medium
                            ${data.roomsIsBooked === 'Booked' ? 'bg-green-400 text-white' : 'bg-red-400 text-white'
                                                }`}>{data.roomsIsBooked}
                                        ...
                                        <div className="flex justify-between space-x-8 items-start w-full">
                                            <p className="text-base dark:text-white xl:text-lg leading-6"><span
                                                className="text-red-500">${data.price}</span></p>
                                            <p className="text-base dark:text-gray-950 font-bold xl:text-lg leading-6">Room No :<span
                                                className="text-gray-950">{data.id}</span></p>
                                            <p className="text-base dark:text-red-600 xl:text-lg font-semibold leading-6 text-gray-800">${data.price}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
