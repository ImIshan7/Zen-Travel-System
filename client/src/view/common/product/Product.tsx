...
export class Product extends Component <ProductProps,ProductState>{
    ...
    render() {
        ...
        const buttonText = this.state.isButtonDisabled ? 'Login Account' : 'Buy Now';
        ...
        return (
                ...
                <div className="bg-white rounded-lg  overflow-hidden shadow-lg ring-4 ring-yellow-500 ring-opacity-40
                    max-w-sm">
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex items-baseline">
                            ...
                            <div className="ml-16 text-green-600 text-lg uppercase font-semibold tracking-wide">
                                {data.roomCount}
                            </div>
                        </div>
                    ...
                    {this.state.isImagePopupOpen && (
                        <div className="fixed top-0 left-0 w-full h-full bg-black font-bold bg-opacity-75 flex items-center justify-center">
                            <img
