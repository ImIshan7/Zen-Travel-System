    ...
    render() {
        return (
            <div className="mt-8">
                ...
                <img className="h-7 w-7 ml-4 pt-1 rounded-md" src={logo} alt="Logo" />*/}
                <footer>
                            ...
                            <div className="-mx-4 flex flex-wrap justify-between">
                                <div className="px-4 my-4 w-full xl:w-1/5">
                                            ...
                                            <g fill="none" fill-rule="evenodd">
                                                <g transform="translate(0 -75)">
                                                    <g transform="translate(0 75)">
                                                        ...
                                                        <rect x="149" y="176" width="220" height="220"
                                                              fill="#fff"></rect>
                                                    ...
                                                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="420"
                                                          font-weight="bold">
                                                        <tspan x="654" y="518">Zen Traveller</tspan>
                                                    </text>
                                                </g>
                                            </g>
                                        </svg>
                                    ...
                                    <p className="text-justify">
                                        ZEN TEC is a collection of UI Components created using Tailwind CSS
                                        Framework. The UI Components gives you all of the building blocks you need to
                                        build any designs without any annoying opinionated styles you have to fight to
                                        override.
                                    </p>
                                </div>
                                ...
                                <div className="px-4 my-4 w-full sm:w-auto">
                                    ...
                                    <ul className="leading-8">
                                        <li><a href="#" className="hover:text-blue-400">Getting Started With HTML and
                                            CSS</a></li>
                                        <li><a href="#" className="hover:text-blue-400">What Is Flex And When to Use
                                            It?</a></li>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="-mx-4 flex flex-wrap justify-between">
                                <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                    Copyright © 2020
                                    {/* <script>new Date().getFullYear() > 2020 && document.write("- " + new
                                        Date().getFullYear())</script>*/}- 2024
                                    ZEN TEC. All Rights Reserved.
                                </div>
                                <div className="px-4 w-full text-center sm:w-auto sm:text-left">
                                    Made By ZEN TEC.
                                </div>
